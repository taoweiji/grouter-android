...
public class RouterDelegateCodeBuilder {
    ...
    public static void buildJavaFile(String projectName, String centerName, List<RouterDelegateModel> delegateModels, File sourceDir) {
        ...
        AnnotationSpec annotationSpec = AnnotationSpec.builder(SuppressWarnings.class).addMember("value", "{\"unchecked\",\"PrimitiveArrayArgumentToVarargsMethod\"}").build();
        taskCenter.addAnnotation(annotationSpec);
//        projectName = "Waimai";
