...
public class GDelegateCenter {
  ...
  public static Account2ServiceDelegate Account2Service(Context context, int uid, int[] uids,
      Map userMap, List users, User user, String[] names) {
  ...
  public static class Account2ServiceDelegate {
    ...
    Account2ServiceDelegate(Context context, int uid, int[] uids, Map userMap, List users,
