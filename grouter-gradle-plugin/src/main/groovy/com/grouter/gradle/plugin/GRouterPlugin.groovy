...
class GRouterPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        def OBJECT_GROUTER_ANDROIDX = ext.properties.get("GROUTER_ANDROIDX")
        ...
        if (OBJECT_GROUTER_ANDROIDX != null) {
            GROUTER_ANDROIDX = Boolean.valueOf(OBJECT_GROUTER_ANDROIDX)
        }
